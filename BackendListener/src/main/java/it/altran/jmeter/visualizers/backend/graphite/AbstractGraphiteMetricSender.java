...
abstract class AbstractGraphiteMetricsSender implements GraphiteMetricsSender {
    ...
    protected GenericKeyedObjectPool<SocketConnectionInfos, SocketOutputStream> createSocketOutputStreamPool() {
        ...
        SocketOutputStreamPoolFactory sockFack=new SocketOutputStreamPoolFactory(1000, 1000);
        GenericKeyedObjectPool<SocketConnectionInfos, SocketOutputStream> gop =  new GenericKeyedObjectPool(sockFack, config);
        return gop;
    }
